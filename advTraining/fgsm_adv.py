'''
    model_cifar和model_cifar_new两种模型进行fgsm攻击测试
'''
import keras
...
if __name__ == '__main__':
    # model_keras = keras.models.load_model('model_cifar.h5')  #76.95
    model_keras = keras.models.load_model('model_cifar_new.h5') # 87.26
    batch_size = 512
    success = 0
